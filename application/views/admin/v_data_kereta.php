...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Data Pemesanan Tiket Kereta Api</h1>
        </div>
        <div class="container">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Tabel Pemesanan Tiket Kereta Api</h4>
                    ...
                    <?php foreach($data_log as $r) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url()."admin/delete_kereta/".$r->id_pemesanan ?>" class="tombol-hapus"><button class="btn btn-outline-danger">Delete</button></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody> 
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        ...
        <div class="modal-header">
            <h5 class="modal-title">Tambah Pemesanan Tiket Kereta Api</h5>
        ...
        <div class="row">
            <div class="col-md-6">
            <form method="POST" action="<?= base_url()."admin/proses_tambah_kereta/" ?>">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Detail Pemesanan Tiket Kereta Api</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Edit Pemesanan Tiket Kereta Api</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                    <form method="POST" action="<?= base_url()."admin/proses_edit_kereta/" ?>">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 offset-1 col-form-label">Id Penumpang </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="id_penumpang" value="<?= $r->id_pemesanan ?>">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="col-sm-2 offset-1 col-form-label">Id Rute </label>
                            <div class="col-sm-8">
                                <select class="form-control" name="id_rute">
                                    <option><?php echo $r->id_rute ?></option>
                                    <?php foreach ($rute->result() as $row) {
                                        echo "<option value='".$row->id_rute."'>".$row->id_rute;?></option>";
                                    <?php } ?>
                                </select>
