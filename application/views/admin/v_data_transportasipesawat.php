...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Data Transportasi Pesawat</h1>
        </div>
        <div class="container">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Tabel Transportasi Pesawat</h4>
                    ...
                    <?php foreach($data_log as $r) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url()."admin/delete_transportasipesawat/".$r->id_transportasi ?>" class="tombol-hapus"><button class="btn btn-outline-danger">Delete</button></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody> 
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url()."admin/proses_tambah_transportasipesawat/" ?>">   
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        ...
        <div class="modal-body">
        <form method="POST" action="<?= base_url()."admin/proses_edit_transportasipesawat/" ?>">   
        <div class="form-group row">
